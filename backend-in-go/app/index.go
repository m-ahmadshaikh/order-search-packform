...
func main() {
	...
	router.HandleFunc("/orders", GetOrders).Methods("GET", "OPTIONS")
	router.HandleFunc("/order_items", GetOrderItems).Methods("GET", "OPTIONS")
	router.HandleFunc("/deliveries", GetDeliveries).Methods("GET", "OPTIONS")
	router.HandleFunc("/customers", GetCustomers).Methods("GET", "OPTIONS")
	router.HandleFunc("/customer_companies", GetCustomerCompanies).Methods("GET", "OPTIONS")
